...
class Vista():
    ...
    def __init__(self, root):
        ...
        self.sexo_var = IntVar(value=0)
        self.cp_var = StringVar()
        self.cuit_var = StringVar()
        ...
        Nombre_label = Label(self.root, text="Ingrese los datos del Cliente", bg="darkblue", fg="White", font="Raleway", width=88)
        Nombre_label.grid(column=1, row=0, padx=5, pady=10, columnspan=5, sticky="NSEW")

        Documento_label = Label(self.root, text="Documento") 
        ...
        Movil_label = Label(self.root, text="Teléfono Móvil") 
        ...
        Sexo_label = Label(self.root, text="Sexo") 
        Sexo_label.grid(column=1, row=3, padx=10, pady=5, sticky="EW")
        Sexo_Fem_radiobtn = Radiobutton(self.root, text="Femenino", variable=self.sexo_var, value=0)
        Sexo_Fem_radiobtn.grid(column=2, row=3, padx=10, pady=5)
        Sexo_Masc_radiobtn = Radiobutton(self.root, text="Masculino", variable=self.sexo_var, value=1)
        Sexo_Masc_radiobtn.grid(column=3, row=3, padx=10, pady=5)

        CP_label = Label(self.root, text="Código Postal") 
        CP_label.grid(column=4, row=3, padx=10, pady=5, sticky="EW")
        self.CP_entry = Entry(self.root, width=25, textvariable=self.cp_var)
        self.CP_entry.grid(column=5, row=3, padx=10, pady=5)


        # -------------------- BOTONES --------------------
        self.alta_btn = Button(self.root, width=12, borderwidth=4, relief=RAISED, text="Alta", highlightbackground="Gray", fg="black")
        self.alta_btn.grid(column=1, row=10, padx=15, pady=15)
        self.modificacion_btn = Button(self.root, width=12, borderwidth=4, relief=RAISED, text="Modificación", highlightbackground="Gray", fg="black")
        self.modificacion_btn.grid(column=2, row=10, padx=5, pady=15)
        self.baja_btn = Button(self.root, width=12, borderwidth=4, relief=RAISED, text="Baja", highlightbackground="Gray", fg="black")
        self.baja_btn.grid(column=3, row=10, padx=5, pady=15)
        self.generarpdf_btn = Button(self.root, width=12, borderwidth=4, relief=RAISED, text="Generar PDF", highlightbackground="Gray", fg="black")
        self.generarpdf_btn.grid(column=4, row=10, padx=5, pady=15)
        self.generarlog_btn = Button(self.root, width=12, borderwidth=4, relief=RAISED, text="Generar log", highlightbackground="Gray", fg="black")
        self.generarlog_btn.grid(column=5, row=10, padx=10, pady=15)

        
        # ------------- TABLA VISOR DE MOVIMIENTOS  ------------
        self.tree = ttk.Treeview(self.root, height=12, columns=("#1", "#2", "#3", "4", "5", "6"), selectmode="browse")
        ...
        self.tree.heading('#2', anchor= CENTER, text="Documento")
        self.tree.heading('#3', anchor= CENTER, text="Móvil")
        self.tree.heading('#4', anchor= CENTER, text="Sexo")
        self.tree.heading('#5', anchor= CENTER, text="CP")
        self.tree.heading('#6', anchor= CENTER, text="CUIL")
    ...
    def VentanaEdicion(self): 
        ...
        self.cp_actualizado_var = StringVar()
        ...
        # --------- ETIQUETAS E INGRESO DE DATOS ----------
        Nuevo_Nombre_label = Label(VentanaEdicion, text="Ingrese los Nuevos Datos del Cliente", bg="Violet", fg="White", font="Raleway", width=88)
        ...
        Nuevo_Movil_label = Label(VentanaEdicion, text="Nuevo Teléfono Móvil") 
        ...
        Nuevo_CP_label = Label(VentanaEdicion, text=" Nuevo Código Postal") 
        Nuevo_CP_label.grid(column=3, row=2, padx=5, pady=5, sticky="E")
        self.CP_entry = Entry(VentanaEdicion, width=25, textvariable=self.cp_actualizado_var)
        self.CP_entry.grid(column=4, row=2, padx=5, pady=5, columnspan=2)


        # -------------------- BOTONES --------------------
        self.edicion_btn = Button(VentanaEdicion, width=10, borderwidth=8, relief=RAISED, text="Actualizar", highlightbackground="lightgray")
