...
class Vista():
    ...
    def __init__(self, root):
        ...
        Nombre_label = Label(self.root, text="Ingrese los datos del Canal", bg="darkblue", fg="White", font="Raleway", width=88)
        ...
        Movil_label = Label(self.root, text="Móvil") 
    ...
    def VentanaEdicion(self): 
        ...
        # --------- ETIQUETAS E INGRESO DE DATOS ----------
        Nuevo_Nombre_label = Label(VentanaEdicion, text="Ingrese los Nuevos Datos del Canal", bg="darkblue", fg="White", font="Raleway", width=88)
        ...
        Nuevo_Movil_label = Label(VentanaEdicion, text="Nuevo Móvil") 
